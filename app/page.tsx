...
export default function Page() {
  ...
  return (
    ...
    <main className="pt-24">
      ...
      {/* ══════════════ FOOTER ══ */}
      <footer className="border-t border-gray-200/70 px-6 py-16 dark:border-white/10" style={{background:"rgba(245,240,235,0.97)", colorScheme:"light"}}>
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              <img src="/IDECN_LOGO1.svg" alt="IDECN" className="h-10 w-auto" />
              <p className="mt-4 text-sm leading-relaxed text-gray-700 dark:text-gray-900">
              ...
              <p className="mt-3 text-sm text-gray-600 dark:text-gray-800">8415 Oak Bush Terrace, Columbia, MD 21045</p>
            ...
            <div>
              ...
              <div className="mt-4 space-y-3 text-sm text-gray-600">
                <div><span className="font-semibold text-gray-800">Organization:</span> <a href="mailto:indoecnetwork@gmail.com" className="hover:underline" style={{color:"#C84B2F"}}>indoecnetwork@gmail.com</a></div>
                <div><span className="font-semibold text-gray-800">Event:</span> <a href="mailto:indonesiaday@gmail.com" className="hover:underline" style={{color:"#C84B2F"}}>indonesiaday@gmail.com</a></div>
              </div>
              <div className="mt-5 text-sm font-extrabold uppercase tracking-[0.18em]" style={{color:"#4A4A4A"}}>Key Contacts</div>
              <div className="mt-3 space-y-2 text-sm text-gray-600">
                <div><span className="font-semibold text-gray-800">Haris Koentjoro</span> — <a href="tel:+14435709509" className="hover:opacity-70">(443) 570-9509</a></div>
                <div><span className="font-semibold text-gray-800">Endang Setyowati</span> — <a href="tel:+12404836113" className="hover:opacity-70">(240) 483-6113</a></div>
              </div>
            </div>
            <div>
              ...
              <div className="mt-4 space-y-3">
                {MEDIA.map((m) => (
                  <a key={m.outlet} href={m.href} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-2 text-sm text-gray-600 hover:opacity-70 transition">
                    <span className="h-1.5 w-1.5 shrink-0 rounded-full" style={{background:"#C84B2F"}} />
                    {m.outlet}
                  </a>
                ))}
          ...
          <div className="mt-12 border-t border-gray-300/50 pt-6 dark:border-white/20 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <span className="text-xs text-gray-500">© {new Date().getFullYear()} {orgShort} — {orgName}. All rights reserved.</span>
            <span className="text-xs text-gray-400">Established 2024 · Columbia, MD, USA</span>
          </div>
        </div>
      </footer>
